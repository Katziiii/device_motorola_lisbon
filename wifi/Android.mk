...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service-lazy.lisbon.rc
...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service.lisbon.xml
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service-lazy.lisbon
...
LOCAL_REQUIRED_MODULES := \
    android.hardware.wifi@1.0-service-lazy.lisbon.rc \
    android.hardware.wifi@1.0-service.lisbon.xml
